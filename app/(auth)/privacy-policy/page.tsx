export default function PrivacyPolicy() {
  return (
    <div className='text-md space-y-12 pb-4 text-gray-500 md:pb-8 md:text-lg'>
      <p>Effective Date: 12.02.2024</p>
      <p>
        At Conversio, we are committed to safeguarding your privacy. This
      ...
      <div className='space-y-2'>
        ...
        <p>
          ...
          data we collect, please contact us at lennard@recke-media.de
        </p>
      </div>

      <p>
        By using Conversio, you agree to the practices outlined in this Privacy
