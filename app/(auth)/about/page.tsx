export default function About() {
  return (
    <div className='text-md space-y-12 pb-4 text-gray-500 md:pb-8 md:text-lg'>
      <p>
        Introducing Conversio, the ultimate multimedia conversion powerhouse
      ...
      <div className='space-y-2'>
        ...
        <p>
          Access Conversio from any device with an internet connection. Whether
      ...
      <div className='space-y-2'>
        <h2 className='text-xl font-medium text-gray-700 md:text-2xl'>
          🌟 It's Free, It's Powerful, It's Conversio:
        </h2>
        <p>
